...
export function MessagesTab({
      ...
      <div className="flex-1 p-3.5 space-y-3 overflow-y-auto">
        <div className="text-center my-1">
          <span className="text-[10px] bg-slate-200/80 text-slate-600 px-2.5 py-0.5 rounded-full font-medium">
            Kênh trao đổi ca {activeConv.shift.shift_start} - {activeConv.shift.shift_end}
          </span>
        </div>
  ...
  // NẾU LÀ GIAO DIỆN MOBILE: CHỈ HIỂN THỊ 1 PANEL ĐƠN DUY NHẤT
  if (isMobile) {
    return (
  ...
  // NẾU LÀ GIAO DIỆN DESKTOP: HIỂN THỊ ĐỦ 3 CỘT SONG SONG
  return (
