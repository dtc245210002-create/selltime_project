...
export const INITIAL_SHIFTS: Shift[] = [
  ...
  {
    id: "shift_gap_01",
    employer_id: "emp_lunch_07",
    employer_name: "Bếp Cơm & Cafe Sinh Viên TNUT",
    employer_avatar: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=100&auto=format&fit=crop&q=80",
    cover_image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=600&auto=format&fit=crop&q=80",
    title: "Phục vụ ca gãy trưa cao điểm (11:00 - 13:30)",
    description: "Bưng bê đồ ăn, tiếp thực và lau dọn bàn trong khung giờ cao điểm sinh viên ăn trưa. Nhận tiền ví ngay sau ca.",
    work_type: "GIG",
    shift_date: "Hôm nay",
    shift_start: "11:00",
    shift_end: "13:30",
    ...
    store_perks: ["🍚 Bao cơm trưa ngon", "❄️ Phòng máy lạnh", "⚡ Nhận tiền ngay 13h30"],
    friendly_tags: ["⚡ Ca gãy trưa 2.5h", "📍 2p đi bộ từ TNUT", "🍲 Lương cao 35k/h"],
    location_coords: {
      latitude: 21.586,
      longitude: 105.828,
    },
    location_address: "Số 26 Đường 3/2, đối diện cổng trường TNUT",
    status: "OPEN",
    created_at: "2026-09-12T07:00:00Z",
  },
  {
    id: "shift_gap_02",
    employer_id: "emp_bbq_08",
    employer_name: "Lẩu Nướng & BBQ Thái Nguyên",
    employer_avatar: "https://images.unsplash.com/photo-1544025162-d76694265947?w=100&auto=format&fit=crop&q=80",
    cover_image: "https://images.unsplash.com/photo-1544025162-d76694265947?w=600&auto=format&fit=crop&q=80",
    title: "Phụ bếp & Tiếp thực ca gãy tối (17:30 - 20:30)",
    description: "Hỗ trợ chuẩn bị rau lẩu, xếp đĩa thịt nướng và chuyển đồ lên bàn cho khách trong 3 tiếng giờ vàng.",
    work_type: "PART_TIME",
    shift_date: "Hôm nay",
    shift_start: "17:30",
    shift_end: "20:30",
    ...
    filled_candidates: 1,
    is_sos: false,
    required_skills: ["Phục vụ bàn", "Cẩn thận"],
    store_perks: ["🍖 Bao bữa tối lẩu nướng", "🛵 Gửi xe miễn phí", "🎵 Không gian sôi động"],
    friendly_tags: ["⚡ Ca gãy tối 3.0h", "🔥 Quán đông khách", "💵 Tiền tươi về ví ngay"],
    location_coords: {
      latitude: 21.591,
      longitude: 105.832,
    },
    location_address: "105 Phan Đình Phùng, TP. Thái Nguyên",
    status: "OPEN",
